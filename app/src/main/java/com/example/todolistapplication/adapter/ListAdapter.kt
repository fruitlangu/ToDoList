...
import com.example.todolistapplication.databinding.ItemTolistBinding

import com.inavi.myapplication.model.OnItemClick
import com.inavi.myapplication.model.ToDoList


class ListAdapter(private val listData: List<ToDoList>, private val onClick: OnItemClick) :
...
class ListViewHolder(val binding: ItemTolistBinding, val onClick: OnItemClick) : RecyclerView.ViewHolder(binding.root),
    ...
    fun bindData(toDoListData: ToDoList) {
